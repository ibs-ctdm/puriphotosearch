...
class HelpPanel(QWidget):
    ...
    def _build_instructions(self) -> QWidget:
        ...
        layout.addWidget(self._step_list([
            ...
            ("4. กด \"ดำเนินการ\"", "ระบบจะคัดลอกรูปเข้าโฟลเดอร์ตามชื่อ และเพิ่มบุคคลใหม่เข้าฐานข้อมูลอัตโนมัติ"),
        ]))
        ...
        layout.addWidget(self._step_list([
            ...
            ("3. เปิดแท็บ \"ค้นหาจากรายชื่อ\"", "ติ๊กเลือกบุคคลที่ต้องการค้นหา แล้วกด \"ดำเนินการ\""),
            ("4. ดูผลลัพธ์", "ระบบจะค้นหาและคัดลอกรูปเข้าโฟลเดอร์ตามชื่อให้อัตโนมัติ"),
        ]))
